...
set ::env(DESIGN_NAME) scan_wrapper_341359304823013970
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341359304823013970.v \
$::env(DESIGN_DIR)/scan_wrapper_341359304823013970.v"
